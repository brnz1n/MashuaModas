...
<div class="col-12 col-md-auto">
    <div class="card text-white bg-dark" align="center">
        <h3 class="card-header">Estoque</h3>
    </div>
    <br>
    <div class="card text-white bg-dark" align="center">
        <a class="btn btn-dark" href="adicionar.php">Adicionar <i class="fas fa-dolly"></i></a>
    </div>
    <br>
            ...
            <tbody>
                ...
                while ($dados = mysqli_fetch_array($resultado)):
                    ...
                    <tr align="center">  
                        ...
                        <td> <?php echo $dados['valorCompra'].'.00'; ?></td>
                        <td> <?php echo $dados['valorVenda'].'.00'; ?> </td>
                        <td> <a href="editar.php?id= <?php echo $dados['id']; ?>" class="btn btn-light">
